...
if(!file_exists('config.json')){
	$token = readline('𝙷𝚒 𝚂𝙰𝚁𝙰 𝙴𝚗𝚝𝚎𝚛 𝚃𝚘𝚔𝚎𝚗: ');
	$id = readline('𝙷𝚒 𝚂𝙰𝚁𝙰 𝙴𝚗𝚝𝚎𝚛 𝙸𝚍: ');
	...
	$callback = function ($update, $bot) {
      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/E77711/1023",
                   'caption'=>'𝙏𝙝𝙞𝙨 𝘽𝙤𝙩 𝙋𝙧𝙤𝙜𝙧𝙖𝙢𝙚𝙙 𝘽𝙮 : @E77710 💙️',
		    ...
		    $bot->sendMessage([
		       'chat_id'=>$chatId,
                'message_id'=>$mid,
                'text'=>"𝙏𝙝𝙞𝙨 𝘽𝙤𝙩 𝙋𝙧𝙤𝙜𝙧𝙖𝙢𝙚𝙙 𝘽𝙮 : @E77710 💙",
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'👨 Add Accounts🛗','callback_data'=>'login']],
                          [['text'=>'🔎 Geting users','callback_data'=>'grabber']],
                          [['text'=>'▶️ Start Checking','callback_data'=>'run'],['text'=>' ⏸Stop Checking','callback_data'=>'stop']],
                          [['text'=>'⚙️Accounts Status','callback_data'=>'status']],
                          [['text'=>' قناتي♥','url'=>'t.me/E77711'],['text'=>'المطوره 🙂','url'=>'t.me/E77710']],    
                      ]
                  ])
              ]);   
          }  if($text == '- عربي 🇪🇬'){
		       ...
		       'chat_id'=>$chatId,
                ...
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'بدء الصيد ▶️','callback_data'=>'run'],['text'=>'ايقاف الصيد ⏸','callback_data'=>'stop']],
            ...
            $bot->sendMessage([
		       'chat_id'=>$chatId,
                'message_id'=>$mid,
                'text'=>".𖡃. 𝐂𝐡 :- l @E77711  -   @L77710BOT  -   @E88810BOT
𝐓𝐞𝐥𝐞 : @E77710 |",
          		...
          		if($mode == 'addL'){
          			...
          			if(isset($body->message)){
          				...
          				$keyboard = ['inline_keyboard'=>[
										[['text'=> "☠️🛠️ أضافه حساب وهمي جديد",'callback_data'=>'addL']]
									]];
...
𝙏𝙝𝙞𝙨 𝘽𝙤𝙩 𝙋𝙧𝙤𝙜𝙧𝙖𝙢𝙚𝙙 𝘽𝙮 : @E77710 💙",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'🔘إضافة حساب  ','callback_data'=>'login']],
                          [['text'=>'🛸طرق الصيد ','callback_data'=>'grabber']],
                          [['text'=>'.♻️ بدء الصيد','callback_data'=>'run'],['text'=>'.🚫 ايقاف الصيد','callback_data'=>'stop']],
                          [['text'=>'حالة الحسابات ☢️','callback_data'=>'status']]
                      ]
                  ])
                  ]);
...
لشراء نسخه مراسلة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'مطوره البـــــــ𝙎𝘼𝙍𝘼ـــــوت','url'=>'t.me/E77710']],
                          [['text'=>"قناه المطــــــ𝙎𝘼𝙍𝘼ـــــوره", 'url'=>"https://t.me/E77711"]],
                      ]
                  ])
              ]);   
				}
